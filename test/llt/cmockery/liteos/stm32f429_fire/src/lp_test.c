...
static VOID timer1_callback(UINT32 arg)
{
    ...
    dprintf("l'm timer1, g_timercount1=%d ,tick_last1=%d .\n", g_timercount1, tick_last1);
...
static VOID timer2_callback(UINT32 arg)
{
    ...
    dprintf("l'm timer2, g_timercount2=%d ,tick_last2=%d .\n", g_timercount2, tick_last2);
}
...
static int lp_main(void)
{
    ...
    osal_task_create("task2", task1, 0, 0x800, NULL, 11);

#if (LOSCFG_BASE_CORE_SWTMR_ALIGN == YES)
    LOS_SwtmrCreate(1000, LOS_SWTMR_MODE_PERIOD, timer1_callback, &id1, 1, OS_SWTMR_ROUSES_ALLOW, OS_SWTMR_ALIGN_SENSITIVE);
    LOS_SwtmrCreate(2000, LOS_SWTMR_MODE_PERIOD, timer2_callback, &id1, 1, OS_SWTMR_ROUSES_ALLOW, OS_SWTMR_ALIGN_SENSITIVE);
#else
    LOS_SwtmrCreate(1000, LOS_SWTMR_MODE_PERIOD, timer1_callback, &id1, 1);
    LOS_SwtmrCreate(2000, LOS_SWTMR_MODE_PERIOD, timer2_callback, &id1, 1);
#endif
    LOS_SwtmrStart(id1);
    LOS_SwtmrStart(id2);
    ...
    for (;;)
    {
        ...
        printf("l'm lp_main, sleep 2500ms\n");
    }
}
